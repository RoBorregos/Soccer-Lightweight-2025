...
// Photo Treshold
const int kPhotoTresholdLeft = 100; // threshold adjusted with motors turned on with daylight
const int kPhotoTresholdRight = 490;
const int kPhotoTresholdFront = 35; // threshold adjusted with motors turned on with daylight
