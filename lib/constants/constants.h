...
const uint8_t kMaxPWM = 200; // We set a max PWM to limit the motors movement for better performance and control
const uint8_t kMinPWM = 50; // We set the minimum PWM that the robot needs to move
